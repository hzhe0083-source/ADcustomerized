...
WSGI_APPLICATION = 'ad_printing.wsgi.application'
ASGI_APPLICATION = 'ad_printing.asgi.application'
...
if DB_ENGINE == 'sqlite':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='ad_printing'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ADPrinting API',
    'DESCRIPTION': '数码广告打印工厂管理系统API',
    'VERSION': '1.0.0',
